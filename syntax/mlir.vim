...
syn match mlirOps /\<linalg\.softmax\>/
syn match mlirOps /\<linalg\.winograd_filter_transform\>/
syn match mlirOps /\<linalg\.winograd_input_transform\>/
syn match mlirOps /\<linalg\.winograd_output_transform\>/
syn match mlirOps /\<linalg\.yield\>/

" Linalg structured ops.
syn match mlirOps /\<linalg\.batch_matmul\>/
syn match mlirOps /\<linalg\.batch_reduce_matmul\>/
syn match mlirOps /\<linalg\.broadcast\>/
syn match mlirOps /\<linalg\.contract\>/
syn match mlirOps /\<linalg\.elementwise\>/
syn match mlirOps /\<linalg\.generic\>/
syn match mlirOps /\<linalg\.map\>/
syn match mlirOps /\<linalg\.matmul\>/
syn match mlirOps /\<linalg\.reduce\>/
syn match mlirOps /\<linalg\.transpose\>/

" Linalg relayout ops.
syn match mlirOps /\<linalg\.pack\>/
syn match mlirOps /\<linalg\.unpack\>/

" Linalg named ops.
syn match mlirOps /\<linalg\.abs\>/
syn match mlirOps /\<linalg\.add\>/
syn match mlirOps /\<linalg\.batch_matvec\>/
syn match mlirOps /\<linalg\.batch_mmt4d\>/
syn match mlirOps /\<linalg\.batch_vecmat\>/
syn match mlirOps /\<linalg\.ceil\>/
syn match mlirOps /\<linalg\.conv_1d\>/
syn match mlirOps /\<linalg\.conv_1d_ncw_fcw\>/
syn match mlirOps /\<linalg\.conv_1d_nwc_wcf\>/
syn match mlirOps /\<linalg\.conv_2d\>/
syn match mlirOps /\<linalg\.conv_2d_nchw_fchw\>/
syn match mlirOps /\<linalg\.conv_2d_nchw_fchw_q\>/
syn match mlirOps /\<linalg\.conv_2d_ngchw_fgchw\>/
syn match mlirOps /\<linalg\.conv_2d_ngchw_gfchw\>/
syn match mlirOps /\<linalg\.conv_2d_ngchw_gfchw_q\>/
syn match mlirOps /\<linalg\.conv_2d_nhwc_fhwc\>/
syn match mlirOps /\<linalg\.conv_2d_nhwc_fhwc_q\>/
syn match mlirOps /\<linalg\.conv_2d_nhwc_hwcf\>/
syn match mlirOps /\<linalg\.conv_2d_nhwc_hwcf_q\>/
syn match mlirOps /\<linalg\.conv_2d_nhwgc_gfhwc\>/
syn match mlirOps /\<linalg\.conv_2d_nhwgc_gfhwc_q\>/
syn match mlirOps /\<linalg\.conv_3d\>/
syn match mlirOps /\<linalg\.conv_3d_ncdhw_fcdhw\>/
syn match mlirOps /\<linalg\.conv_3d_ndhwc_dhwcf\>/
syn match mlirOps /\<linalg\.conv_3d_ndhwc_dhwcf_q\>/
syn match mlirOps /\<linalg\.copy\>/
syn match mlirOps /\<linalg\.depthwise_conv_1d_ncw_cw\>/
syn match mlirOps /\<linalg\.depthwise_conv_1d_nwc_wc\>/
syn match mlirOps /\<linalg\.depthwise_conv_1d_nwc_wcm\>/
syn match mlirOps /\<linalg\.depthwise_conv_2d_nchw_chw\>/
syn match mlirOps /\<linalg\.depthwise_conv_2d_nhwc_hwc\>/
syn match mlirOps /\<linalg\.depthwise_conv_2d_nhwc_hwcm\>/
syn match mlirOps /\<linalg\.depthwise_conv_2d_nhwc_hwcm_q\>/
syn match mlirOps /\<linalg\.depthwise_conv_2d_nhwc_hwc_q\>/
syn match mlirOps /\<linalg\.depthwise_conv_3d_ncdhw_cdhw\>/
syn match mlirOps /\<linalg\.depthwise_conv_3d_ndhwc_dhwc\>/
syn match mlirOps /\<linalg\.depthwise_conv_3d_ndhwc_dhwcm\>/
syn match mlirOps /\<linalg\.div\>/
syn match mlirOps /\<linalg\.div_unsigned\>/
syn match mlirOps /\<linalg\.dot\>/
syn match mlirOps /\<linalg\.erf\>/
syn match mlirOps /\<linalg\.exp\>/
syn match mlirOps /\<linalg\.fill\>/
syn match mlirOps /\<linalg\.fill_rng_2d\>/
syn match mlirOps /\<linalg\.floor\>/
syn match mlirOps /\<linalg\.log\>/
syn match mlirOps /\<linalg\.matvec\>/
syn match mlirOps /\<linalg\.max\>/
syn match mlirOps /\<linalg\.min\>/
syn match mlirOps /\<linalg\.mmt4d\>/
syn match mlirOps /\<linalg\.mul\>/
syn match mlirOps /\<linalg\.negf\>/
syn match mlirOps /\<linalg\.pooling_nchw_max\>/
syn match mlirOps /\<linalg\.pooling_nchw_sum\>/
syn match mlirOps /\<linalg\.pooling_ncw_max\>/
syn match mlirOps /\<linalg\.pooling_ncw_sum\>/
syn match mlirOps /\<linalg\.pooling_ndhwc_max\>/
syn match mlirOps /\<linalg\.pooling_ndhwc_min\>/
syn match mlirOps /\<linalg\.pooling_ndhwc_sum\>/
syn match mlirOps /\<linalg\.pooling_nhwc_max\>/
syn match mlirOps /\<linalg\.pooling_nhwc_max_unsigned\>/
syn match mlirOps /\<linalg\.pooling_nhwc_min\>/
syn match mlirOps /\<linalg\.pooling_nhwc_min_unsigned\>/
syn match mlirOps /\<linalg\.pooling_nhwc_sum\>/
syn match mlirOps /\<linalg\.pooling_nwc_max\>/
syn match mlirOps /\<linalg\.pooling_nwc_max_unsigned\>/
syn match mlirOps /\<linalg\.pooling_nwc_min\>/
syn match mlirOps /\<linalg\.pooling_nwc_min_unsigned\>/
syn match mlirOps /\<linalg\.pooling_nwc_sum\>/
syn match mlirOps /\<linalg\.powf\>/
syn match mlirOps /\<linalg\.quantized_batch_matmul\>/
syn match mlirOps /\<linalg\.quantized_matmul\>/
syn match mlirOps /\<linalg\.reciprocal\>/
syn match mlirOps /\<linalg\.round\>/
syn match mlirOps /\<linalg\.rsqrt\>/
syn match mlirOps /\<linalg\.select\>/
syn match mlirOps /\<linalg\.sqrt\>/
syn match mlirOps /\<linalg\.square\>/
syn match mlirOps /\<linalg\.sub\>/
syn match mlirOps /\<linalg\.tanh\>/
syn match mlirOps /\<linalg\.vecmat\>/
